...
def extract_label_data(text):
    ...
    for i, line in enumerate(lines):
        ...
        if match_hyphen:
            ...
            if match_slash:
                val6_numerator = match_slash.group(1)
                val6_denominator = match_slash.group(2)
    ...
    return [product_name, val1, val2, val345, val6_numerator, val6_denominator]
...
def main():
    st.set_page_config(page_title="部材シール PDF to CSV Converter")
